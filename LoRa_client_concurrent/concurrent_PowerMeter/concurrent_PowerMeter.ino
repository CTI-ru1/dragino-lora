...
void read_current(String * message)
{
    char sensorvalue[10];
    float value = (float)em1.calcIrms(1480);  
    value=value*1000;
    if (value<100)
    {
      value=0.00;
    }
    dtostrf(value,3,2,sensorvalue);
    *message +="/cur/1,"+ String(sensorvalue);
    Serial.print("My cur 1:");
    Serial.println(value);
    Serial.println(sensorvalue);


    value = (float)em2.calcIrms(1480);  
    value=value*1000;
    ...
    dtostrf(value,3,2,sensorvalue);
     *message +="+cur/2,"+String(sensorvalue);
  
    value = (float)em3.calcIrms(1480);  
    value=value*1000;
    if (value<100)
    {
      value=0.00;
    ...
    dtostrf(value,3,2,sensorvalue);
    *message+="+cur/3,"+ (String)sensorvalue+"+";

    Serial.print("My cur 3:");
    Serial.println(value);
    Serial.println(sensorvalue);
    
    Serial.print("meassage3:");
